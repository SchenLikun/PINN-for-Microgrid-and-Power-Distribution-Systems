...
class PID():
    ...
    def build(self, transform=None, **kwargs):
        ...
        data = dde.data.PDE(
            geom,
            self.pi_ode,
            [ic0, observe_y0, ic1, observe_y1, ic2, observe_y2, ic3, observe_y3, ic4, observe_y4],
            anchors=observe_t,
        )
        ...
        if transform is not None:
            ...
            def output_transform(t, y):
                ...
                y2 = linear + factor * torch.Tensor([1, 1, 1, 1, 1]).to(y.device) * y
                y2[0, 1] = y_true[0, 1]
                y2[0, 3] = y_true[0, 3]
...
if __name__ == "__main__":
    ...
    microgird.build(transform='None',
                    net=dde.nn.FNN([1] + [100] * 3 + [5], "swish", "Glorot uniform"),
                    lr=1e-3,
                    iterations=5000000)
